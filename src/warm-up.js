...
var vegetables = ['kale', 'spinach', 'carrots', 'potatoes', 'broccoli'];
...
var fruits = ['apples', 'bananas', 'oranges', 'strawberry', 'blueberry', 'cherry', 'grapefruit']
...
var groceryStore = {
  ...
  isOpen: true,
  yearsOpen: 20,
  products: ['bread', 'frozen food', 'condiments', 'cold drinks']
}
